...
label.0:					#Epilogue
	...
	addu $sp, $sp, 8
	jr $ra
cruxfunc.myPrint:					#prologue
	subu $sp, $sp, 8
	sw $fp, 0($sp)
	sw $ra, 4($sp)
	addi $fp, $sp, 8
	li $t0, 7				# adding LiterlInt
	subu $sp, $sp, 4
	sw $t0, 0($sp)
	jal cruxfunc.myInt			 # Function Call
	addi $sp, $sp, 4
 	subu $sp, $sp, 4
	sw $v0, 0($sp)
	lw $t0, 0($sp)
	addiu $sp, $sp, 4
	li $t0, 8				# adding LiterlInt
	subu $sp, $sp, 4
	sw $t0, 0($sp)
	jal cruxfunc.myInt			 # Function Call
	addi $sp, $sp, 4
...
main:					#prologue
	...
	sw $ra, 4($sp)
	addi $fp, $sp, 8
	jal cruxfunc.myPrint			 # Function Call
label.2:					#Epilogue
	li    $v0, 10
	syscall
                              # END Code Segment
